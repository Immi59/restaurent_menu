...
from src.schemas.manager_schema import ManagerCreate, ManagerBase, ManagerUpdate, ManagerFilter, ManagerLogin
from src.api.v1.dependancies import get_manager_service, get_current_manager
...
def delete_manager(
    ...
    return service.delete(session, manager_id)  # noqarn service.delete(session, manager_id)  # noqa